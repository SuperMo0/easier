...
Backend engineer who owns features from design to production. Built and shipped a platform serving enterprise clients, with modular service boundaries, multi-tenant APIs and the CI/CD and observability around them. Coaches six competitive programming teams.

...
**PLATFORM ENGINEER · INFRASTRUCTURE · TERRAFORM · CI/CD**
...
Infrastructure-focused engineer who owns the systems other engineers build on — Terraform across staging and production, containerised services, keyless deploy pipelines, and the observability that catches failures before users do.

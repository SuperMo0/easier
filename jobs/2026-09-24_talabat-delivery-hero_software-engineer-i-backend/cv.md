...
**SOFTWARE ENGINEER · BACKEND · .NET · GO · DISTRIBUTED SYSTEMS**
...
Backend engineer with a platform in production for enterprise clients: REST APIs in ASP.NET Core over PostgreSQL, event-driven services in Go and Kafka, and automated tests gating every deploy. Currently building a last-mile delivery platform covering shipments, trips, drivers and hubs.

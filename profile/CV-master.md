...
- Grew organic traffic by improving search ranking and page performance — structured data, Core Web Vitals and WCAG AA compliance — tracking indexing and query performance in **Google Search Console**.
...
**Web & SEO:** SEO, Google Search Console, structured data (Schema.org), Core Web Vitals, WCAG AA accessibility
